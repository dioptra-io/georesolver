"""evaluate and plot results shown in Figure 4 lef of GeoResolver's paper"""
...
def plot() -> None:
    ...
    plot_multiple_cdf(
        cdfs=cdfs,
        output_path="figure_4_left_georesolver_vs_hg_dependency",
...
def main(
    ...
    """
    plot figure 4 left:
        - load all hostnames configuration (with/without NSO/HIO)
        - compute redirection distance between target and vps
        - select vps based on smallest redirection distance
        - plot figure
    """
