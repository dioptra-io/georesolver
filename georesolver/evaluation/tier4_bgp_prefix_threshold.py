...
from georesolver.common.utils import get_d_errors_georesolver
...
RESULTS_PATH = path_settings.RESULTS_PATH / "tier4_evaluation"
...
if __name__ == "__main__":
    do_compute_scores = True
    do_vp_selection = True
    do_plot = True

    if do_compute_scores:
        compute_score()
