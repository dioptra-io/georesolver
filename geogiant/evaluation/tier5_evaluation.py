...
def compute_score() -> None:
    ...
    hostname_per_org = load_json(path_settings.DATASET / "best_hostnames_per_org.json")
    ...
    for nb_hostnames in nb_hostnames_per_org:
        ...
        for org in hyper_giants_orgs.items():

            hostnames = hostname_per_org[org]
        ...
        output_path = (
            ...
            / f"tier2_evaluation/scores__{nb_hostnames}_hostname_hypergiants_orgs.pickle"
        )
