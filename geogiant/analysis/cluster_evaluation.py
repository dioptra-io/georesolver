...
def get_no_ping_cluster_vp(
    ...
    # cluster_scores = get_cluster_scores_avg(ecs_vps_per_cluster, vps_coordinates)
...
def ecs_dns_vp_selection_eval(
    ...
    for target in tqdm(targets):
        ...
        if not cluster_shortest_ping_addr:
...
async def main() -> None:
    ...
    pairwise_distance = load_json(path_settings.OLD_VPS_PAIRWISE_DISTANCE)
