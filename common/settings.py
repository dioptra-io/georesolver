...
class CommonSettings(BaseSettings):
    ...
    # main datasets
    RAW_HOSTNAMES: Path = HOSTNAME_DATASET / "cdn_hostnames.csv"
...
class ClickhouseSettings(BaseSettings):
    ...
    # ZDNS tables
    DNS_MAPPING_TARGETS_TABLE: str = "raw_dns_mapping_targets"
    DNS_MAPPING_VPS_TABLE: str = "raw_dns_mapping_vps"
    DNS_MAPPING_METADATA_TARGETS_TABLE: str = "dns_mapping_metadata_targets"
    DNS_MAPPING_METADATA_VPS_TABLE: str = "dns_mapping_metadata_vps"

    # RIPE Atlas tables
    # TODO: one table for ping targets + flag?
    PING_VPS_TO_TARGETS_TABLE: str = "ping_vps_to_targets"
    PING_VPS_TO_SUBNET_TABLE: str = "ping_vps_to_subnet"
    PING_VPS_TO_POP_TABLE_TABLE: str = "ping_vps_to_pop"
    PING_TARGET_TO_POP_TABLE_TABLE: str = "ping_target_to_pop"

    # geolocation
    # TODO: final results table
